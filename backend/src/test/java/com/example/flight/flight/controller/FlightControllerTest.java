...
class FlightControllerTest {
    ...
    void recordsSearchHistoryOnlyAfterSuccessfulSearch() {
        ...
        when(flightRepository.search(any(FlightSearchCriteria.class), eq(user.id()))).thenReturn(List.of());
        ...
        inOrder.verify(flightRepository).search(any(FlightSearchCriteria.class), eq(user.id()));
    ...
    void doesNotRecordSearchHistoryWhenSearchFails() {
        ...
        when(flightRepository.search(any(FlightSearchCriteria.class), eq(user.id()))).thenThrow(new RuntimeException("db down"));
